                ...
                <div className="bg-white p-8 sm:p-10 shadow-[0_10px_40px_rgba(0,0,0,0.02)] border border-gray-100/50 rounded-2xl">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <button
                                type="submit"
                                className="group relative w-full flex justify-center py-4 px-4 bg-[#5A31F4] text-white text-[16px] font-bold rounded-xl hover:bg-[#4a28cc] focus:outline-none transition-all duration-300 shadow-lg active:scale-[0.98]"
                            >
                                Sign in with shop
                            </button>
                        </div>
                    ...
                    <div className="text-center mt-8 pt-6 border-t border-gray-50">
                        <p className="text-sm text-gray-400">
                            New to Kaisori?
                            <Link to="/signup" className="ml-2 font-bold text-[#5A31F4] hover:underline">Create Account</Link>
                        </p>
                    </div>
                </div>
